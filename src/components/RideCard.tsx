...
const RideCard: React.FC<RideCardProps> = ({
  ...
  return (
    <div className="relative h-[346px] min-w-[246px] w-[246px] overflow-hidden rounded-lg shadow-lg group">
      ...
      <div className="absolute bottom-0 left-0 right-0 flex flex-col p-3 pb-2.5 text-white"> {/* Added text-white here */}
        ...
        <div
          className={`
            ...
            ${buttonBgColor} ${buttonTextColor} {/* Use updated variables */}
