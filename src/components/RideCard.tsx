...
const RideCard: React.FC<RideCardProps> = ({
  ...
  const buttonBgColor = 'bg-yellow-400'; 
  const buttonTextColor = 'text-indigo-900'; 

  return (

    <div className="relative h-[346px] min-w-[246px] w-[246px] overflow-hidden rounded-lg shadow-lg group"> {/* Added shadow & group for potential hover effects later */}
      ...
      <div className="absolute bottom-0 left-0 right-0 flex flex-col p-3 pb-2.5 text-white">
        ...
        <div
          className={`
            ...
            transition-transform duration-200 ease-in-out group-hover:scale-105 // Example hover effect
          `}
          tabIndex={0} 
        >
          Ride Details
